import { chromium } from "file:///C:/Users/Takoua%20Saadani/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/node_modules/playwright/index.mjs";
...
page.on("response", (response) => {
  if (!response.url().startsWith("https://formsubmit.co/")) return;
  captured.responses.push({ url: response.url(), status: response.status() });
});
...
captured.formDataAtSubmit = await page.locator("form[data-lead-form]").evaluate((form) =>
